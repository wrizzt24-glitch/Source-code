			...
			<div class="row">
				<div class="col-md-12">
					<div class="mu-featured-area" style="margin-top: -80px;">
					 <br><h2><strong>View All Appointment Detail</strong></h2><br>
    			...
    			<table>
                            ...
                            <td><a href="Encrypted_Report.jsp?fname=<%=r.getString("filename")%>&&uname=<%=r.getString("username")%>&&dname=<%=r.getString("name")%>"><%=r.getString("filename")%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></td>
