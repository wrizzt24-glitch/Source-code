...
<html lang="en">
  <head>
    ...
    <title>Building and Querying : Knowledge Graph</title>
    <!-- Favicon -->
		  ...
		  <div class="container-fluid">
		    ...
		    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		      	<ul class="nav navbar-nav mu-menu navbar-right">
                            ...
                            <li><a href="Hospital_Login.jsp">Hospital</a></li>
                            <li><a href="Insurance_Login.jsp">Insurance </a></li><li>
                            <li><a href="Bank_Login.jsp">Bank</a></li>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="mu-featured-area" style="margin-top: -80px;">
						<h2>Enabling Authorized Encrypted Search for Multi-Authority Medical Databases</h2>
					</div>
				</div>			
			</div>
		</div>
